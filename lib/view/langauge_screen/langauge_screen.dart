...
class _LangaugeScreenState extends State<LangaugeScreen> {
  ...
  final List<Text> languages = [
    TaskyText.languageEnglish,
    TaskyText.languageArabic,
    TaskyText.languageSpanish,
    TaskyText.languageFrance,
  ];
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                selectedLanguage = language.data ?? ""; // تعيين القيمة عند التحديد
                              });
                            },
                            child: Container(
                              width: 20.e,
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: selectedLanguage == (language.data ?? "")
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: selectedLanguage == (language.data ?? "")
                                        ? TaskyColor.orange // لون الدائرة الداخلية عند التحديد
                                        : Colors.transparent, // شفاف إذا لم يكن محددًا
                                  ),
                                ),
                              ),
                            ),
